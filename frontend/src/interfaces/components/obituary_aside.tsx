    ...
    return (
        <>
            ...
            <div className="min-h-[500px] ring_gray flex flex-col px-2 py-4">
                <span className="font-semibold text-right">CATÉGORIE : {data[0]?.category}</span>
                <div className="flex flex-row pt-4 ml-1">
                    ...
                    <span className="text-center">
                        ...
                        {data[0]?.deceasedLastname} publié par {data[0]?.userDisplayName} le {formatDate(data[0]?.createdAt!)} ”
                    </span>
                </div>
                ...
                <a href="" className="text-center text-kprimary-500 underline pb-3"><span>Publier un avis de décès</span></a>
                <a href="" className="text-center text-kprimary-500 underline pb-3"><span>Publier un souvenir de décès</span></a>
                <a href="" className="text-center text-kprimary-500 underline pb-3"><span>Publier un anniversaire de décès</span></a>
            </div>
        </>
    )
}